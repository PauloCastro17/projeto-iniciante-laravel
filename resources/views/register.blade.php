<x-layout>
    <main class="py-10">
        ...
        <section class="bg-white max-w-[700px] mx-auto mt-4 p-10 pb-6 border-2">
            ...
            <form action="{{ route('auth.register') }}" method="POST" class="flex flex-col">
                ...
                <div class="flex flex-col gap-2 mb-4">
                    ...
                    <input type="password" name="password_confirmation" placeholder="********" class="bg-white border-2 p-2 @error('password_confirmation') border-red-500 @enderror">
            ...
            <p class="text-center mt-4">Já tem uma conta? <a class="underline hover:opacity-50 transition" href="{{ route('site.login') }}">Faça login</a></p>
